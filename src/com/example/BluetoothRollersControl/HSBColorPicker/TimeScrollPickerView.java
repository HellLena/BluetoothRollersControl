...
public class TimeScrollPickerView extends ScrollPickerView {
	...
	protected void init() {
		String[] separater = getResources().getStringArray(com.example.BluetoothRollersControl.R.array.com_ttshrk_view_scroll_picker_time_separater);
		addSlot(getResources().getStringArray(com.example.BluetoothRollersControl.R.array.com_ttshrk_view_scroll_picker_hour_list), 5, ScrollType.Ranged);
		addSlot(new String[]{separater[0]}, 2, ScrollType.None);
		addSlot(getResources().getStringArray(com.example.BluetoothRollersControl.R.array.com_ttshrk_view_scroll_picker_minute_list), 5, ScrollType.Loop);
